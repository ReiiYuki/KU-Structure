...
public class ElementStore : MonoBehaviour {
    ...
    public static void GeneratePIPE()
    {
        ...
        PIPE.Add(new PElement("15 mm x 0.972 kg", 21.7f, 2f, 0.972f, 1.238f, cm ^ 4f, 0.00700219213309808f, 0.56f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("20 mm x 1.41 kg", 27.2f, 2.3f, 1.41f, 1.799f, 0.607f, 0.00885307155976081f, 1.03f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("25 mm x 1.8 kg", 34f, 2.3f, 1.8f, 2.291f, 1.41f, 0.011231464190637f, 1.7f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("32 mm x 2.29 kg", 42.7f, 2.3f, 2.29f, 2.919f, 2.89f, 0.0143011222150021f, 2.8f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("40 mm x 2.63 kg", 48.6f, 2.3f, 2.63f, 3.345f, 5.97f, 0.0163938812458168f, 3.7f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("40 mm x 3.58 kg", 48.6f, 3.2f, 3.58f, 4.654f, 8.99f, 0.0159231070254589f, 4.86f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("50 mm x 4.52 kg", 60.5f, 3.2f, 4.52f, 5.76f, 11.8f, 0.0202844357410635f, 7.84f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("50 mm x 5.57 kg", 60.5f, 4f, 5.57f, 7.1f, 23.7f, 0.0200351803262218f, 9.41f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("65 mm x 5.77 kg", 76.3f, 3.2f, 5.77f, 7.349f, 28.5f, 0.0258742891817069f, 12.9f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("65 mm x 7.13 kg", 76.3f, 4f, 7.13f, 9.085f, 49.2f, 0.0255915162056903f, 15.6f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("80 mm x 6.78 kg", 89.1f, 3.2f, 6.78f, 8.636f, 59.5f, 0.0303980082719467f, 17.9f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("80 mm x 8.39 kg", 89.1f, 4f, 8.39f, 10.69f, 79.8f, 0.0301229162630518f, 21.8f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("90 mm x 7.76 kg", 101.6f, 3.2f, 7.76f, 9.892f, 97f, 0.0348296066035566f, 23.6f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("90 mm x 9.63 kg", 101.6f, 4f, 9.63f, 12.26f, 120f, 0.0345089061015597f, 28.8f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("100 mm x 8.77 kg", 114.3f, 3.2f, 8.77f, 11.17f, 146f, 0.0392407804977604f, 30.2f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("100 mm x 12.2 kg", 114.3f, 4.5f, 12.2f, 15.52f, 172f, 0.0388295243180094f, 41f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("100 mm x 15 kg", 114.3f, 5.6f, 15f, 19.12f, 234f, 0.0384723994964254f, 49.6f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("125 mm x 15 kg", 139.8f, 4.5f, 15f, 19.3f, 283f, 0.0476385353659563f, 62.7f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("125 mm x 19.8 kg", 139.8f, 6f, 19.8f, 25.22f, 438f, 0.0473735220852963f, 80.9f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("150 mm x 17.8 kg", 165.2f, 4.5f, 17.8f, 22.72f, 566f, 0.0568386646818598f, 88.9f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("150 mm x 23.6 kg", 165.2f, 6f, 23.6f, 30.01f, 734f, 0.0563229607534144f, 115f, 14700000f, 24500000f, 1f));
        PIPE.Add(new PElement("175 mm x 22.9 kg", 190.7f, 5f, 22.9f, 29.17f, 952f, 0.0657229514106931f, 132f, 14700000f, 24500000f, 1f));
